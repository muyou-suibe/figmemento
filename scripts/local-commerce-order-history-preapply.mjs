...
${check(`NOT EXISTS(SELECT 1 FROM pg_proc p JOIN pg_namespace n ON n.oid=p.pronamespace WHERE n.nspname='local_commerce' AND p.proname='read_order_history')`,'unapplied history RPC survived')}
END $after$;`;
